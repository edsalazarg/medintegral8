...
{{--                        </td>--}}
                        ...
                        <td>
                            <div>
                            <a href="/patients/{{$patient->id}}" class="btn btn-sm btn-clean btn-icon mr-2" title="Ver paciente">
...
{{--                            <a href="{{route('patients.edit', ['patient' => $patient->id])}}"></a>--}}
                            <a href="/patients/{{$patient->id}}/edit" class="btn btn-sm btn-clean btn-icon mr-2" title="Editar paciente">
                            ...
                            <a href="javascript:;" class="btn btn-sm btn-clean btn-icon mr-2" title="Eliminar paciente" data-toggle="modal" data-target='{{"#exampleModal_$patient->id"}}'>
                            ...
                            <div class="modal fade" id='{{"exampleModal_$patient->id"}}' tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ¿Estas seguro que quieres eliminar al paciente:{{$patient->firstName." ".$patient->lastName}}?
                                        </div>
