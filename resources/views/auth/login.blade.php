...
<head><base href="../../../../">
    ...
    <link href="{{asset("dist/assets/css/pages/login/login-4.css")}}" rel="stylesheet" type="text/css" />
    ...
    <div class="login login-4 wizard d-flex flex-column flex-lg-row flex-column-fluid">
        ...
        <div class="login-container order-2 order-lg-1 d-flex flex-center flex-row-fluid px-7 pt-lg-0 pb-lg-0 pt-4 pb-6 bg-white">
            ...
            <div class="login-content d-flex flex-column pt-lg-0 pt-12">
                <!--begin::Logo-->
{{--                    <h3 class="text-primary font-weight-bolder">SISTEMA DE MEDICINA INTEGRAL</h3>--}}
{{--                    <img src="{{asset("images//logo_udg.png")}}"  alt="" />--}}
{{--                    <br><br><br>--}}
                <!--end::Logo-->
                <!--begin::Signin-->
                    ...
                    <form class="form" id="kt_login_singin_form" action="">
                        ...
                        <div class="pb-5 pb-lg-15">
                            ...
                            <div class="text-muted font-weight-bold font-size-h4">No tienes una cuenta?
                                <a href="{{asset("custom/pages/login/login-4/signup.html")}}" class="text-primary font-weight-bolder">Crear cuenta</a></div>
                        </div>
                        <!--begin::Title-->
                        <!--begin::Form group-->
                        ...
                        <div class="pb-lg-0 pb-5">
                            <button type="submit" id="kt_login_singin_form_submit_button" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Iniciar sesion</button>
                        </div>
                        <!--end::Action-->
                    </form>
                    <!--end::Form-->
...
<script src="{{asset("dist/assets/js/pages/custom/login/login-4.js")}}"></script>
<!--end::Page Scripts-->
</body>
<!--end::Body-->
</html>
