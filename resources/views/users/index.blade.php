    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="{{route('auth.register')}}" class="btn btn-primary font-weight-bolder">
        ...
        <div class="card-body">
            ...
            <!--end: Search Form-->
            <!--begin: Datatable-->
            <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable_users">
                <thead>
                <tr>
                    {{--                    <th title="id">ID</th>--}}
                    ...
                    <th title="email">Correo electrónico</th>
                ...
                @foreach($users as $key => $user)
                    <tr>
                        ...
                        <td>
                            <div>
                            <a href="/users/{{$user->id}}" class="btn btn-sm btn-clean btn-icon mr-2" title="Ver usuario">
                            ...
                            <a href="/users/{{$user->id}}/edit" class="btn btn-sm btn-clean btn-icon mr-2" title="Editar usuario">
                            ...
                            <a href="javascript:;" class="btn btn-sm btn-clean btn-icon mr-2" title="Eliminar usuario" data-toggle="modal" data-target='{{"#exampleModal_$user->id"}}'>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ¿Estas seguro que quieres eliminar al usuario:{{$user->name}}?
                                        </div>
