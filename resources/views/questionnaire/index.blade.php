                ...
                <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable_questionnaires">
                    ...
                    @foreach($questionnaires as $key => $questionnaire)
                        <tr>
                            ...
                            <a href="javascript:;" class="btn btn-sm btn-clean btn-icon mr-2" title="Eliminar historial clinico" data-toggle="modal" data-target='{{"#exampleModal_$questionnaire->id"}}'>
                            ...
                            <div class="modal fade" id='{{"exampleModal_$questionnaire->id"}}' tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ¿Estas seguro que quieres eliminar el cuestionario del paciente:{{$questionnaire->patient->firstName." ".$questionnaire->patient->lastName}}?
                                        </div>
